...
import { User, CheckCircle, Calendar, MessageCircle, Heart, Sparkles } from 'lucide-react'
  ...
  return (
    <section className="product-section relative overflow-hidden" style={{ backgroundColor: '#140627' }}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-16 left-16 w-4 h-4 bg-yellow-400/30 rounded-full blur-sm animate-pulse"></div>
        <div className="absolute top-40 right-24 w-5 h-5 bg-yellow-400/25 rounded-full blur-md animate-pulse" style={{ animationDelay: '1.4s' }}></div>
        <div className="absolute bottom-40 left-1/4 w-3 h-3 bg-yellow-400/35 rounded-full blur-sm animate-pulse" style={{ animationDelay: '0.6s' }}></div>
        <div className="absolute top-48 right-1/3 w-6 h-6 bg-yellow-400/20 rounded-full blur-lg animate-pulse" style={{ animationDelay: '2.2s' }}></div>
        <div className="absolute bottom-16 right-16 w-4 h-4 bg-yellow-400/28 rounded-full blur-md animate-pulse" style={{ animationDelay: '1.7s' }}></div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Exclusive 1-on-1 coaching with The Transformation Architect. Limited spots available per quarter.
            </motion.p>
          </motion.div>

          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            {/* Left Column: Coaching Visual */}
            <motion.div
                ...
                <div className="relative bg-gradient-to-br from-gray-800 to-gray-700 rounded-3xl p-10 shadow-2xl border border-gray-600">
                  <div className="text-center">
                    <div className="w-56 h-72 bg-gradient-to-br from-yellow-500/30 to-yellow-600/30 rounded-2xl mx-auto mb-8 flex items-center justify-center border border-yellow-500/30 shadow-xl">
                      <div className="text-center">
                        <User className="h-20 w-20 text-yellow-400 mx-auto mb-4" />
                    ...
                    <div className="bg-gradient-to-r from-yellow-500/20 to-yellow-600/20 rounded-2xl p-6 border border-yellow-500/30">
                      <div className="text-4xl font-bold text-yellow-400 mb-2">1-on-1</div>
                      <div className="text-gray-300 text-lg">Exclusive Access</div>
                    </div>
                  </div>
                </div>
            ...
            >
              <motion.div variants={itemVariants}>
                ...
                <ul className="space-y-6">
                  ...
                  <li className="flex items-start space-x-4 p-4 bg-gray-700/50 rounded-xl border border-gray-600 hover:bg-gray-700/70 transition-colors">
                    <CheckCircle className="h-6 w-6 text-yellow-400 mt-1 flex-shrink-0" />
                    <span className="text-gray-300 text-lg">Unlimited Voxer access</span>
                  </li>
                  <li className="flex items-start space-x-4 p-4 bg-gray-700/50 rounded-xl border border-gray-600 hover:bg-gray-700/70 transition-colors">
                    <CheckCircle className="h-6 w-6 text-yellow-400 mt-1 flex-shrink-0" />
                    <span className="text-gray-300 text-lg">Custom identity blueprint</span>
                  </li>
                  <li className="flex items-start space-x-4 p-4 bg-gray-700/50 rounded-xl border border-gray-600 hover:bg-gray-700/70 transition-colors">
                    <CheckCircle className="h-6 w-6 text-yellow-400 mt-1 flex-shrink-0" />
                    <span className="text-gray-300 text-lg">Priority support & guidance</span>
                  </li>
                  <li className="flex items-start space-x-4 p-4 bg-gray-700/50 rounded-xl border border-gray-600 hover:bg-gray-700/70 transition-colors">
                    <CheckCircle className="h-6 w-6 text-yellow-400 mt-1 flex-shrink-0" />
                    <span className="text-gray-300 text-lg">Exclusive mastermind access</span>
                  </li>
                </ul>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="therapeutic-card">
                ...
                <p className="text-gray-300 text-lg">High-achieving entrepreneurs ready for breakthrough results</p>
              </motion.div>

              <motion.div variants={itemVariants} className="bg-yellow-500/10 rounded-2xl p-6 border border-yellow-500/30">
                <div className="flex items-center space-x-3 mb-3">
                  <Calendar className="h-5 w-5 text-yellow-400" />
                  <span className="font-semibold text-white">Limited Availability:</span>
                </div>
                <p className="text-gray-300 text-lg">Only 5 spots available per quarter</p>
              </motion.div>

              <motion.a 
                href="/coaching" 
                variants={itemVariants} 
                className="btn-primary text-xl px-10 py-6 w-full flex items-center justify-center shadow-xl"
              >
          ...
          >
            <div className="therapeutic-card max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold text-white mb-8">Exclusive Transformation Experience</h3>
              <div className="flex items-center justify-center space-x-12 text-gray-300">
                <div className="flex items-center space-x-3">
                  <User className="h-8 w-8 text-yellow-400" />
                  <div>
                    <div className="text-2xl font-bold">5</div>
                    <div className="text-gray-400">Spots Available</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
